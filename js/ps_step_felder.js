 ...
 blocks.push(blockB);
  ...
  blocks.push(new BlockCore(
   ...
   blocks.push(new BlockCore(
     world,
     {
       x: 1100, y: 550 , w: 150, h: 10, color: ('#EEB411'),
       trigger: (ball, blocks) => { //Trigger für Musik
        //console.log("Trigger", ball, blocks); 
        elise_A2.play();
      }
    ...
    blocks.push(new BlockCore(
      world,
      {
        x: 1100, y: 750, w: 150, h: 10, color: ('#EEB411'), 
        trigger: (ball, blocks) => { //Trigger für Musik
          //console.log("Trigger", ball, blocks); 
          elise_A2.play();
        }
      ...
      blocks.push(new BlockCore(
       ...
       blocks.push(new BlockCore(
        world,
        {
          x: 1100, y: 950, w: 150, h: 10, color: ('#EEB411'), 
          trigger: (ball, blocks) => { //Trigger für Musik
            //console.log("Trigger", ball, blocks); 
            elise_A2.play();
          }
 ...
 //Teil B
  ...
  blocks.push(new BlockCore(
   ...
   blocks.push(new BlockCore(
    world,
    {
      x: 500, y:  6000, w: 200, h: 10, color: ('#EEB411'), 
      trigger: (ball, blocks) => { //Trigger für Musik
       //console.log("Trigger", ball, blocks); 
       elise_E4.play();
     }
...
//Treppe
   ...
   blocks.push(new BlockCore(
     world,
     {
       x:410, y: 6950, w: 100, h: 10, color: ('#EEB411'), 
       trigger: (ball, blocks) => { //Trigger für Musik
        //console.log("Trigger", ball, blocks); 
        elise_F2.play();
